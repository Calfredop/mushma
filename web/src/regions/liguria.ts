  ...
  copy: {
    it: {
      ...
      intro: {
        ...
        porcini:
          "La mappa divide i boschi della Liguria in celle di 1 km e dà a ognuna un indice delle condizioni da 0 a 1 per i porcini: più è alto, più meteo, bosco e quota sono adatti in quel giorno. Mostra dove le condizioni sono buone, non dove si trovano i funghi. La stagione va dall'estate ai primi freddi, con il picco tra settembre e ottobre, nei castagneti e nei faggeti dell'entroterra, dalla Val d'Aveto alle Alpi Liguri.",
        ovoli:
          "La mappa divide i boschi della Liguria in celle di 1 km e dà a ognuna un indice delle condizioni da 0 a 1 per gli ovoli: più è alto, più meteo, bosco e quota sono adatti in quel giorno. Mostra dove le condizioni sono buone, non dove si trovano i funghi. La stagione va da giugno a novembre, soprattutto tra fine estate e autunno, nei castagneti e nei querceti delle colline dell'entroterra.",
        gallinacci:
          "La mappa divide i boschi della Liguria in celle di 1 km e dà a ognuna un indice delle condizioni da 0 a 1 per i gallinacci: più è alto, più meteo, bosco e quota sono adatti in quel giorno. Mostra dove le condizioni sono buone, non dove si trovano i funghi. La stagione dura quasi tutto l'anno, con i picchi in primavera e in autunno, nei castagneti e nei faggeti dell'entroterra.",
      },
      dataset: {
