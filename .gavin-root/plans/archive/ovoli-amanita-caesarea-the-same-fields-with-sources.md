---
kind: task
title: Ovoli (*Amanita caesarea*): the same fields, with sources
parent: m3-species-ecology-research.md
---
You are a research agent for the mushma project. Execute this card end to end.

## Task: ovoli (*Amanita caesarea*)

Research *Amanita caesarea* ("ovolo buono") in Tuscany: a thermophilic species of oak
(cerro, roverella, leccio, sughera) and chestnut woods in the lower hills, usually
July–October, after warm storms. Treat that summary as a hypothesis to confirm or correct.
Pin down what "warm soil after rain" means in numbers (soil or air temperature, rain amount,
lag), how high it goes in Tuscany, and what stops it (cool nights, drought after the
storm, the first autumn cold).

Leads to check. These are unverified pointers; confirm them before citing, and find better
ones if you can:
- Università di Siena mycocoenological studies of Tuscan oak and chestnut woods (Perini,
  Salerni, Laganà)
- Daza et al. 2006/2007 (*Mycorrhiza*) on *A. caesarea* temperature and pH in culture
  (lab evidence: label it as such)
- Baptista et al. 2010 (*Fungal Ecology*) on the fruiting pattern of chestnut macrofungi in
  NE Portugal
- Spanish and Portuguese studies of *Quercus pyrenaica* / chestnut stands with *A. caesarea*
  yield or phenology data
- AMB / Rivista di Micologia, and Italian regional mycological groups' notes on ovolo
  phenology

**Write your draft to:** `.gavin-root/docs/drafts/species-ecology-ovoli.md`

> Done 2026-09-17. The draft was merged as the evidence appendix `.gavin-root/docs/species-ecology/ovoli.md`; its rules are encoded in `.gavin-root/docs/species-rules/`.
