...
| GAL-07 | s.l. | aspect (optional) | Below 600 m from June to September, give moister north- and east-facing slopes a slight edge. | slope ≥ 10°: N/NE/E ×1.0, S/SW/W ×0.85; flatter ×0.95 **(derived)** | folklore | R1 (moist-site preference), R32 | available |
